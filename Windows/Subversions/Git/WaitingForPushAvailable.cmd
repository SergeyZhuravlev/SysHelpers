...
cd
git branch -D z/Backup2920
git branch z/Backup2920 || goto backupFailed
:waitingLoop
...
pause
(git rebase --abort || del .git/rebase-apply) && git reset --hard z/Backup2920 && echo Aborting rebase probably success. && pause && exit
